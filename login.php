            ...
            <div class=" col-md-5 col-lg-4 col-xs-10 mx-auto my-auto order-1 order-md-2">
                ...
                <div class="d-flex justify-content-around mt-3">
                    <div class="d-flex align-items-center gap-1">
                        ...
                        <div class="pt-1 small">Recuerdame</div>
                    </div>
                    <div class="pt-1">
                        <a href="#" class="fw-semibold small blue">¿Contraseña olvidada?</a>
                    </div>
                </div>
                <div class=" d-flex">
                    <button class="btn text-white mx-auto w-50 mt-4 fw-semibold shadow-sm" style="background-color: var(--principal);">
                        Entrar
                    </button>
                </div>
                <div class="d-flex gap-1 justify-content-center mt-3">
                    <div>¿No tienes una cuenta?</div>
                    <p><a href="#" class="fw-semibold">Regístrate</a></p>
                </div>
