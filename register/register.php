...
<head>
    ...
    <script href="https://hcaptcha.com/1/api.js" async defer></script>
    <!-- ENLACE ESTILOS -->
        ...
        <div class="row">
            <div class=" col-md-4 col-lg-4 col-xs-10 mx-auto my-auto order-1 order-md-2">
                <div class="text-center my-3 mb-5">
                    <img src="..\assets\logo-vector\MEDAC_imagotipo_horiz_azul_RGB.svg" class="w-75"
                ...
                <div class="d-flex mx-auto">
                    <div class="mb-4 mx-auto">
                        <div class="h-captcha" data-sitekey="f0a2f562-01ca-4c9a-8f3c-c652120e04fa"></div>
                    </div>
                    <!-- <p>
                        Captcha
                    </p> -->
                ...
                <div class=" d-flex">
                    <button class="btn text-white mx-auto w-50 mt-4 fw-semibold"
                        style="background-color: var(--principal);">
                        Registrar
                    </button>
                </div>
