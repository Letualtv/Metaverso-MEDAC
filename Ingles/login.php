            ...
            <div class=" col-md-5 col-lg-4 col-xs-10 mx-auto my-auto order-1 order-md-2">
                ...
                <div class="d-flex justify-content-around mt-3">
                    <div class="d-flex align-items-center gap-1">
                        ...
                        <div class="pt-1 small text-secondary">Remember me</div>
                    </div>
                    <div class="pt-1">
                        <a href="#" class="blue text-decoration-underline">Forgot password?</a>
                    </div>
                </div>
                <div class=" d-flex">
                ...
                <div class="d-flex gap-1 justify-content-center mt-3">
                    ...
                    <p><a href="register.php" class="blue text-decoration-underline">Sign up</a></p>
                </div>
